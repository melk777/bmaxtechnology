...
const whatsapp = "https://wa.me/5545988167775?text=Ol%C3%A1%2C%20quero%20um%20or%C3%A7amento%20para%20um%20carregador%20Bmax.";
...
export default function Home() {
  ...
  return <main>
    <nav className="topbar"><a className="brand" href="#inicio"><img src="/logo-bmax.png" alt="Bmax Technology" /><span>Bmax <b>Technology</b></span></a><div className="toplinks"><a href="#catalogo">Catálogo</a><a href="/simuladores">Simuladores</a><a href="/visitas">Visitas</a><a href="#projeto">Para empresas</a><a href={whatsapp} target="_blank">WhatsApp ↗</a></div></nav>
    ...
    <section className="simulator-cta" id="simuladores"><div><p className="eyebrow">SIMULADORES BMAX</p><h2>Escolha seu cenário. Planeje com mais segurança.</h2><p>Simule o potencial de faturamento da sua operação ou estime o tempo de recarga do seu veículo em uma experiência feita para cada necessidade.</p></div><a className="button" href="/simuladores">Conhecer simuladores <span>→</span></a></section>
