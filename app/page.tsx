...
const scenes = [
  { id: "resort", number: "01", eyebrow: "HOTÉIS E RESORTS", title: "Ofereça o melhor carregador elétrico do mercado para os seus clientes ou para sua casa.", body: "Transforme seu estacionamento em uma experiência premium para hóspedes e visitantes.", product: "CDZ-T", power: "Recarga rápida DC · 60 kW ou 80 kW", image: "/products/cdz-t.png", className: "resort" },
  ...
  { id: "station", number: "03", eyebrow: "ELETROPOSTOS", title: "Seu posto de combustíveis merece ter o melhor carregador elétrico.", body: "Instale recarga rápida no seu posto e crie uma nova parada para quem está em movimento.", product: "CDZ-WY", power: "Recarga rápida DC · até 120 kW", image: "/products/cdz-wy.png", className: "station" },
  { id: "scale", number: "04", eyebrow: "ALTA POTÊNCIA", title: "Temos carregadores para todos os locais que necessitam.", body: "Projetos robustos para alto fluxo, com equipamentos, instalação e suporte comercial no Sul do Brasil.", product: "CDZ-YE", power: "Recarga rápida DC · até 120 kW", image: "/products/cdz-ye.png", className: "scale" },
];
